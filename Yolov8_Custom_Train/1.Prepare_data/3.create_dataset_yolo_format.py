### After downloading files in data folder. Create yolo format . For this, set DATA_ALL_DIR to your download folder (data)
### Set DATA_OUT_DIR to another folder name (i.e., dataset) where our files will be stored in train,test, val folders in Yolo format.
### Be sure to make directory 'dataset' before running the code. Otherwise train,test,val folders will not be created.
...
DATA_OUT_DIR = os.path.join('.', 'dataset')
